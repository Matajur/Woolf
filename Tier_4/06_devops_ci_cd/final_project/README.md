...
│   │   │   └── hpa.yaml
│   │   ├── Chart.yaml
│   │   └── values.yaml      # ConfigMap with environment variables for Django web application
│   │
│   └── monitoring/
│       ├── templates/
│       │   ├── application.yaml
│       │   ├── servicemonitor.yaml
│       ├── Chart.yaml
│       └── values.yaml      # ConfigMap with environment variables for Prometheus and Grafana
├──django
│			 ├── app\
│			 ├── Dockerfile
│			 ├── Jenkinsfile
