"""DAG module for data processing in the multi-hop datalake"""
...
with DAG(
    dag_id="matajur_multihop_data_processing_dag",
    ...
    landing_to_bronze = SparkSubmitOperator(
        task_id="matajur_landing_to_bronze",
    ...
    bronze_to_silver = SparkSubmitOperator(
        task_id="matajur_bronze_to_silver",
    ...
    silver_to_gold = SparkSubmitOperator(
        task_id="matajur_silver_to_gold",
